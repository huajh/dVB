...
%
% http://www.mathworks.com/matlabcentral/fileexchange/27485-boundedline--line-plots-with-shaded-error-confidence-intervals
...
for iln = 1:nline
    ...
    %hp(iln) = patch(xp{iln}, yp{iln}, ptchcol{iln}, 'edgecolor', 'none');
end
